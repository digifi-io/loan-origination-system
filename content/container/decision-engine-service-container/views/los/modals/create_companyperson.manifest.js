...
module.exports = {
  'containers': {
    '/los/companies/:id/new/new_person': {
      layout: {
            ...
            formgroups: [ {
              ...
              formElements:
                [ {
                  ...
                  label: 'Set as company primary contact',
      ...
      'resources': {
        companydata: '/los/api/customers/companies/:id/add_person?type=new',
        checkdata: {
          url: '/auth/run_checks',
          options: {
    ...
    '/los/companies/:id/new/existing_person': {
      layout: {
        privileges: [ 101, 102, 103 ],
        component: 'Container',
        props: {},
      ...
      'resources': {
        companydata: '/los/api/customers/companies/:id/add_person?type=existing',
        checkdata: {
          url: '/auth/run_checks',
          options: {
            onSuccess: [ 'func:window.redirect', ],
