...
module.exports = {
  'containers': {
      [`/decision/strategies/:id/requirements/copy`]: {
        layout: {
            ...
            props: {
              ...
              formgroups: [ {
                ...
                formElements: [ {
                  ...
                  value: {
                    component: 'span',
                    children: 'Warning: This will replace all current rules and cannot be reversed.',
                  },
                } ]
              }, {
                gridProps: {
        ...
        'resources':  {
          [ `strategydata` ]: `/decision/api/standard_strategies/:id/requirements/copySegment?format=json`,
          checkdata: {
            url: '/auth/run_checks',
            options: {
