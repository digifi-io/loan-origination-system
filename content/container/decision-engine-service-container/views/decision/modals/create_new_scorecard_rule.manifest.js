...
module.exports = {
  'containers': {
    [ `/decision/strategies/:id/scorecard/create` ]: {
      layout: {
        // privileges: [101, 102],
        component: 'div',
        children: [
                ...
                props: {
                  ...
                  formgroups: [ {
                    ...
                    formElements: [
                      ...
                      getRuleFormElement({
                        prop: 'condition_output.weight'
                      }),
                      getRuleFormElement({
                        prop: 'condition_output.weight_type'
                      }),
                    ],
                    order: [
                      'formheader',
                      ...
                      ...getStandardFields(3, standardOrderReducer), 'rule*4*rule_separator',
                  ...
                  renderFormElements: Object.assign({},
                    getStandardFields(0, standardFilterReducer), getStandardFields(1, standardFilterReducer), getStandardFields(2, standardFilterReducer), getStandardFields(3, standardFilterReducer), getStandardFields(4, standardFilterReducer), getStandardFields(5, standardFilterReducer), getStandardFields(6, standardFilterReducer), getStandardFields(7, standardFilterReducer), getStandardFields(8, standardFilterReducer), getStandardFields(9, standardFilterReducer), {
                      ...
                      'condition_output*0*value': 'func:window.weightFilter',
      ...
      'resources': {
        // [ `ruledata` ]: `/decision/api/standard_strategies/:id/scorecard/createRule`,
        checkdata: {
          url: '/auth/run_checks',
          settings: {
