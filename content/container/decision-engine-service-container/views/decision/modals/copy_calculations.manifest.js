...
module.exports = {
  'containers': {
      [`/decision/strategies/:id/calculations/copy`]: {
        layout: {
            ...
            props: {
              ...
              formgroups: [ {
                ...
                formElements: [ {
                  ...
                  value: {
                    component: 'span',
                    children: 'Warning: This will replace all current calculation scripts and cannot be reversed.',
                  },
                } ]
              }, {
                gridProps: {
                ...
                formElements: [ {
                  type: 'submit',
                  value: 'COPY CALCULATION SCRIPTS',
                  passProps: {
                    color: 'isPrimary'
                  },
                  layoutProps: {
        ...
        'resources':  {
          [ `strategydata` ]: `/decision/api/standard_strategies/:id/calculations/copySegment?format=json`,
          checkdata: {
            url: '/auth/run_checks',
            options: {
